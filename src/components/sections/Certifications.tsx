          ...
          return (
            ...
            >
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <h3 className="text-xs md:text-sm font-semibold text-zinc-900 dark:text-zinc-100 tracking-tight group-hover:text-blue-500 transition-colors line-clamp-1 uppercase">
                    {cert.title}
                  </h3>
              ...
              <div className="flex items-center gap-2 shrink-0 text-xs text-zinc-400 dark:text-zinc-500">
                <span>{cert.date}</span>
