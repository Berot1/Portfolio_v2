...
import { affiliations, socialLinks, personalInfo } from '@/data/portfolio'; //[cite: 1]
    ...
    <section className="space-y-6 pt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-3">
          <h3 className="text-xs font-mono font-medium text-zinc-500 uppercase tracking-wider">Affiliations</h3>
          <div className="space-y-2">
            {affiliations.map((item, i) => (
              ...
              >
                <span className="text-xs font-medium text-zinc-900 dark:text-zinc-100 pr-4 leading-snug group-hover:text-blue-500 transition-colors">
                  {item.name}
                </span>
        ...
        {/* 2. Social Links */}
        <div className="space-y-3">
          <h3 className="text-xs font-mono font-medium text-zinc-500 uppercase tracking-wider">Socials</h3>
          <div className="space-y-2">
            {socialLinks.map((item, i) => ( //[cite: 1]
              <a 
                key={i}
                href={item.link}
                target="_blank"
        ...
        {/* 3. Quick Actions */}
        <div className="space-y-3">
          <h3 className="text-xs font-mono font-medium text-zinc-500 uppercase tracking-wider">Direct Contact</h3>
          <div className="space-y-2">
            <a 
              href={`mailto:${personalInfo.email}`} //[cite: 1]
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] text-zinc-400 font-mono font-bold uppercase tracking-widest">Email</span>
              </div>
              <p className="text-xs font-mono font-semibold text-zinc-900 dark:text-zinc-100 group-hover:text-blue-500 transition-colors">
                {personalInfo.email} {/*[cite: 1] */}
              </p>
            </a>
          </div>
        </div>
