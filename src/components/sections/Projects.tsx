          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {project.tags?.[0] && (
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-mono tracking-wider text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800 border border-zinc-200/60 dark:border-zinc-700">
                    {project.tags[0]}
                  </span>
                )}
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 tracking-tight group-hover:text-blue-500 transition-colors">
                    {project.title}
                  </h3>
